...
if ($runQueryID = mysql_query($queryID))
{
    ...
    if ($sortby == "rank")
    {
        $playerQuery = "SELECT * FROM `players` WHERE `id_registrations`='".$id_registrations."' ORDER BY `".$sortby."` ASC";   
    }
    else
    {
        $playerQuery = "SELECT * FROM `players` WHERE `id_registrations`='".$id_registrations."' ORDER BY `".$sortby."` DESC";    
    }
...
<?php if ($sortby == "ot_games_played") { ?>
    <td class="stat_column_selected"><?php echo $f100; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f100; ?></td>
<?php } ?>
<?php if ($sortby == "cup_dif") { ?>
...
<?php } ?>
<?php if ($sortby == "shooting_percentage") { ?>
    <td class="stat_column_selected"><?php echo $f9; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f9; ?></td>
<?php } ?>
<?php if ($sortby == "bounces") { ?>
    <td class="stat_column_selected"><?php echo $f10; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f10; ?></td>
<?php } ?>
<?php if ($sortby == "gang_bangs") { ?>
    <td class="stat_column_selected"><?php echo $f11; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f11; ?></td>
<?php } ?>
<?php if ($sortby == "errors") { ?>
    <td class="stat_column_selected"><?php echo $f12; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f12; ?></td>
<?php } ?>
<?php if ($sortby == "heating_up") { ?>
    <td class="stat_column_selected"><?php echo $f13; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f13; ?></td>
<?php } ?>
<?php if ($sortby == "on_fire") { ?>
    <td class="stat_column_selected"><?php echo $f14; ?></td>
<?php } else { ?>
...
<?php } ?>    
<?php if ($sortby == "loss_streak") { ?>
    <td class="stat_column_selected"><?php echo $f16; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f16; ?></td>
<?php } ?>
<?php if ($sortby == "hit_streak") { ?>
    <td class="stat_column_selected"><?php echo $f17; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f17; ?></td>
<?php } ?>
<?php if ($sortby == "miss_streak") { ?>
    <td class="stat_column_selected"><?php echo $f18; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f18; ?></td>
<?php } ?>
<?php if ($sortby == "elo_rating") { ?>
    <td class="stat_column_selected"><?php echo $f19; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f19; ?></td>
<?php } ?>
<?php if ($sortby == "compound_rating") { ?>
    <td class="stat_column_selected"><?php echo $f20; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f20; ?></td>
<?php } ?>
<?php if ($sortby == "rank") { ?>
    <td class="stat_column_selected"><?php echo $f21; ?></td>
<?php } else { ?>
...
<?php } ?>
<?php if ($sortby == "redemp_hits") { ?>
    <td class="stat_column_selected"><?php echo $f23; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f23; ?></td>
<?php } ?>
<?php if ($sortby == "redemp_shotperc") { ?>
    <td class="stat_column_selected"><?php echo $f24; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f24; ?></td>
<?php } ?>
<?php if ($sortby == "redemp_atmps") { ?>
    <td class="stat_column_selected"><?php echo $f25; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f25; ?></td>
<?php } ?>
<?php if ($sortby == "redemp_succs") { ?>
    <td class="stat_column_selected"><?php echo $f26; ?></td>
<?php } else { ?>
...
<?php } ?>
<?php if ($sortby == "p9") { ?>
    <td class="stat_column_selected"><?php echo $f28; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f28; ?></td>
<?php } ?>
<?php if ($sortby == "p8") { ?>
    <td class="stat_column_selected"><?php echo $f29; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f29; ?></td>
<?php } ?>
<?php if ($sortby == "p7") { ?>
    <td class="stat_column_selected"><?php echo $f30; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f30; ?></td>
<?php } ?>
<?php if ($sortby == "p6") { ?>
    <td class="stat_column_selected"><?php echo $f31; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f31; ?></td>
<?php } ?>
<?php if ($sortby == "p5") { ?>
    <td class="stat_column_selected"><?php echo $f32; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f32; ?></td>
<?php } ?>
<?php if ($sortby == "p4") { ?>
    <td class="stat_column_selected"><?php echo $f33; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f33; ?></td>
<?php } ?>
<?php if ($sortby == "p3") { ?>
    <td class="stat_column_selected"><?php echo $f34; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f34; ?></td>
<?php } ?>
<?php if ($sortby == "p2") { ?>
    <td class="stat_column_selected"><?php echo $f35; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f35; ?></td>
<?php } ?>
<?php if ($sortby == "p1") { ?>
    <td class="stat_column_selected"><?php echo $f36; ?></td>
<?php } else { ?>
    <td class="stat_column"><?php echo $f36; ?></td>
<?php } ?>
<?php if ($sortby == "h1") { ?>
    <td class="stat_column_selected"><?php echo $f37; ?></td>
<?php } else { ?>
